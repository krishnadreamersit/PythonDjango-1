...
SECRET_KEY = 'django-insecure-b+8tjs@3*#dus$ih@5r&fkv-#943bevh_gawkng-bmpy(v5(0('
...
STATIC_ROOT = 'staticfiles' # Creating Non-HTML Contents
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static')
]

# File Upload - Dynamic Files (user upload)
MEDIA_URL = 'media/'
